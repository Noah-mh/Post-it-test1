        ...
        <>
            <ContextMenu>
                <ContextMenuTrigger>
                    ...
                    >
                        ...
                        <Handle
                            ...
                            style={{ background: "#FEB2B2", borderRadius: "4px" }}
                        />
                        <div
                            className="relative"
                            style={{ backgroundColor: data.color, padding: 10 }}
                        >
                            {noteData.pinned ? (
                                <div className="absolute right-1 top-1 rounded-sm bg-white p-1">
                                    <BiPin />
                                </div>
                            ) : null}
                            <div className="flex items-center justify-between space-x-8 pt-2">
                                <input
                                    className={`w-full cursor-text bg-transparent p-2 font-bold ${isInputEditable
                                            ? "focus:outline-auto"
                                            : "focus:outline-none"
                                        } outline-1`}
                                    name="title"
                            ...
                            <textarea
                                className={`h-32 w-full cursor-text bg-transparent p-2 text-sm text-gray-600 ${isTextareaEditable ? "outline" : "outline-none"
                                    } outline-1`}
                                name="description"
                ...
                <ContextMenuContent className="w-64">
                    ...
                    <ContextMenuSeparator />
                    <ContextMenuItem inset>Bring to the front</ContextMenuItem>
                    <ContextMenuItem inset>Bring to the back</ContextMenuItem>
                    <ContextMenuItem inset>Detach from cluster</ContextMenuItem>
                    <ContextMenuSeparator />
                    ...
                    <ContextMenuItem inset>Comment</ContextMenuItem>
                    <ContextMenuItem inset>Start Vote</ContextMenuItem>
